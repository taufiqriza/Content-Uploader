    ...
    <div class="w-full max-w-md relative z-10">
        ...
        <div class="bg-white rounded-2xl shadow-2xl p-8">
            <div class="text-center mb-6">
                ...
                <p class="text-gray-500 text-sm">Daftar gratis dan mulai upload konten!</p>
            </div>

            <!-- Form -->
            <form method="POST" action="{{ filament()->getRegistrationUrl() }}" class="space-y-4">
                @csrf
            ...
            <p class="text-center text-gray-600">
                Sudah punya akun? 
                <a href="{{ filament()->getLoginUrl() }}" class="text-blue-600 hover:text-blue-700 font-semibold">
                    Masuk
                </a>
            </p>
        </div>
